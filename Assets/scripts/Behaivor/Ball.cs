...
public class Ball : MonoBehaviour
{
	...
	private void StuckHandle()
	{
		...
		{
			RB.velocity = new Vector3(RB.velocity.x + rand, RB.velocity.y, RB.velocity.z).normalized * BounceSpeed;
			XCounterStuck = 0;
		}
		else if (YCounterStuck >= ReboundLimit)
		{
			RB.velocity = new Vector3(RB.velocity.x, RB.velocity.y + rand, RB.velocity.z).normalized * BounceSpeed;
			YCounterStuck = 0;
		}
